...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "NADEEM'S SALARY RECORD" },
      { name: "twitter:description", content: "Brandex Law Associates - Employee Salary Management System" },
    ],
    links: [
